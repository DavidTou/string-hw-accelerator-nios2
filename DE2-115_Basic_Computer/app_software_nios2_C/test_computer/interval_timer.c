...
void interval_timer(int *, int *, int []);

void interval_timer_isr( void )
{
	++eight_sec;	// used to decide when to change what is displayed on 7-segs

	interval_timer( & green_LED_pattern, & shift_direction, display_buffer );
...
******************************************************************************/
void interval_timer( int * light_pattern, int * shift_dir, int buffer[])
{
